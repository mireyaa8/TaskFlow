...
public interface ITaskService
{
    ...
    Task AddLabelAsync(int taskId, int labelId, string userId, bool isAdmin = false);

    Task RemoveLabelAsync(int taskId, int labelId, string userId, bool isAdmin = false);
